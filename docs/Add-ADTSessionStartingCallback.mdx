...
[https://psappdeploytoolkit.com/docs/reference/functions/Add-ADTSessionStartingCallback](https://psappdeploytoolkit.com/docs/reference/functions/Add-ADTSessionStartingCallback)
