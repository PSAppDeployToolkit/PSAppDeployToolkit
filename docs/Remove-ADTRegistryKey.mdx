...
```powershell
Remove-ADTRegistryKey -Path <String> [-Name <String>] [-Recurse] [-SID <String>] [<CommonParameters>]
```

### LiteralPath

```powershell
Remove-ADTRegistryKey -LiteralPath <String> [-Name <String>] [-Recurse] [-SID <String>] [<CommonParameters>]
```
