...
Show-ADTInstallationRestartPrompt [-CountdownSeconds <UInt32>] [-CountdownNoHideSeconds <UInt32>]
 [-CustomMessageText <String>] [-NotTopMost] -Title <String> -Subtitle <String> [<CommonParameters>]
```

### NoCountdown

```powershell
Show-ADTInstallationRestartPrompt [-NoCountdown] [-CustomMessageText <String>] [-NotTopMost] -Title <String>
