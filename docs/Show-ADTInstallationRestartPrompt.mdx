...
Show-ADTInstallationRestartPrompt [-CountdownSeconds <UInt32>] [-CountdownNoHideSeconds <UInt32>]
 [-WindowLocation <DialogPosition>] [-CustomText] [-NotTopMost] -Title <String> -Subtitle <String>
 [<CommonParameters>]
```
...
Show-ADTInstallationRestartPrompt [-SilentRestart] [-SilentCountdownSeconds <UInt32>]
 [-WindowLocation <DialogPosition>] [-NotTopMost] -Title <String> -Subtitle <String> [<CommonParameters>]
```
