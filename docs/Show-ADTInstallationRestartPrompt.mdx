...
```powershell
Show-ADTInstallationRestartPrompt [-CountdownSeconds <UInt32>] [-CountdownNoHideSeconds <UInt32>] [-CustomText]
 [-NotTopMost] -Title <String> -Subtitle <String> [<CommonParameters>]
```

### NoCountdown

```powershell
Show-ADTInstallationRestartPrompt [-NoCountdown] [-CustomText] [-NotTopMost] -Title <String> -Subtitle <String>
 [<CommonParameters>]
```
