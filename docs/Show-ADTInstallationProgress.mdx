...
Show-ADTInstallationProgress [[-StatusMessage] <String>] [[-StatusMessageDetail] <String>]
 [[-StatusBarPercentage] <Double>] [[-MessageAlignment] <DialogMessageAlignment>] [[-WindowLocation] <String>]
 [-NotTopMost] [-NoRelocation] -Title <String> -Subtitle <String> [<CommonParameters>]
```
