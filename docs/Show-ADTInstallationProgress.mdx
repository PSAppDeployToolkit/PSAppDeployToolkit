...
```powershell
Show-ADTInstallationProgress [[-WindowLocation] <String>] [[-MessageAlignment] <DialogMessageAlignment>]
 [-NotTopMost] [-NoRelocation] -WindowTitle <String> -WindowSubtitle <String> -StatusMessage <String>
