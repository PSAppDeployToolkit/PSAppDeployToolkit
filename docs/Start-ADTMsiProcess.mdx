...
Start-ADTMsiProcess [-Action <String>] -FilePath <String> [-Transforms <String[]>] [-ArgumentList <String[]>]
 ...
 [-IgnoreExitCodes <String[]>] [-PriorityClass <ProcessPriorityClass>] [-RepairFromSource]
 [-ExitOnProcessFailure] [<CommonParameters>]
```
...
Start-ADTMsiProcess [-Action <String>] -InstalledApplication <InstalledApplication> [-Transforms <String[]>]
 ...
 [-PriorityClass <ProcessPriorityClass>] [-RepairFromSource] [-ExitOnProcessFailure] [<CommonParameters>]
```
