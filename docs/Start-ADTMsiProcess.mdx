...
Start-ADTMsiProcess [-Action <String>] -FilePath <String> [-Transforms <String[]>] [-ArgumentList <String[]>]
 ...
 [-IgnoreExitCodes <String[]>] [-PriorityClass <ProcessPriorityClass>] [-RepairMode <String>]
 [-RepairFromSource] [-ExitOnProcessFailure] [<CommonParameters>]
```
...
Start-ADTMsiProcess [-Action <String>] -InstalledApplication <InstalledApplication> [-Transforms <String[]>]
 ...
 [-PriorityClass <ProcessPriorityClass>] [-RepairMode <String>] [-RepairFromSource] [-ExitOnProcessFailure]
 [<CommonParameters>]
```
