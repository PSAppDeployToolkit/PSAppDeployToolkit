...
Open-ADTSession [[-SessionState] <SessionState>] [[-DeploymentType] <DeploymentType>]
 ...
 [[-AppScriptAuthor] <String>] [-RequireAdmin] [[-InstallName] <String>] [[-InstallTitle] <String>]
 ...
 [[-AppProcessesToClose] <ProcessDefinition[]>] [[-ScriptDirectory] <String[]>] [[-DirFiles] <String>]
 ...
 [-ForceWimDetection] [-ForceMsiDetection] [-PassThru]
