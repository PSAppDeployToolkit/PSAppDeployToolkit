...
Open-ADTSession [-SessionState] <SessionState> [[-DeploymentType] <String>] [[-DeployMode] <String>]
 ...
 [[-DefaultMspFiles] <String[]>] [-DisableDefaultMsiProcessList] [[-LogName] <String>] [-ForceWimDetection]
 [-PassThru] [[-UnboundArguments] <System.Collections.Generic.List`1[System.Object]>] [<CommonParameters>]
```
