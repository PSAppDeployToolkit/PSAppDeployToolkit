...
```powershell
Set-ADTIniValue [-FilePath] <String> [-Section] <String> [-Key] <String> [-Value] <String> [-Force]
 [<CommonParameters>]
```
...
To remove a section, set this parameter to $null.
...
To remove a value, set this parameter to $null.
