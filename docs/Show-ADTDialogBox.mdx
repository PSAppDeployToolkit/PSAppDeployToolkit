...
```powershell
Show-ADTDialogBox [-Text] <String> [-Buttons <MessageBoxButtons>] [-DefaultButton <MessageBoxDefaultButton>]
 [-Icon <MessageBoxIcon>] [-NotTopMost] [-Force] -Title <String> [<CommonParameters>]
```
...
Parameter Sets: (All)
Aliases:
Accepted values: Ok, OkCancel, AbortRetryIgnore, YesNoCancel, YesNo, RetryCancel
