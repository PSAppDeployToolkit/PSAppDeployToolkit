...
Start-ADTProcess -FilePath <String> [-ArgumentList <String[]>] [-SecureArgumentList]
 ...
 [-PriorityClass <ProcessPriorityClass>] [-UseShellExecute] [<CommonParameters>]
```
...
Start-ADTProcess -FilePath <String> [-ArgumentList <String[]>] [-SecureArgumentList]
 ...
 [-IgnoreExitCodes <String[]>] [-PriorityClass <ProcessPriorityClass>] [-UseShellExecute] [<CommonParameters>]
```
