...
Start-ADTProcess -FilePath <String> [-ArgumentList <String[]>] [-SecureArgumentList]
 [-WorkingDirectory <String>] [-CreateNoWindow] [-NoWait] [-SuccessExitCodes <Int32[]>]
...
```powershell
Start-ADTProcess -FilePath <String> [-ArgumentList <String[]>] [-SecureArgumentList]
 [-WorkingDirectory <String>] [-UseShellExecute] [-Verb <String>] [-CreateNoWindow]
...
```powershell
Start-ADTProcess -FilePath <String> [-ArgumentList <String[]>] [-SecureArgumentList]
 [-WorkingDirectory <String>] [-WindowStyle <ProcessWindowStyle>] [-NoWait] [-SuccessExitCodes <Int32[]>]
 [-RebootExitCodes <Int32[]>] [-IgnoreExitCodes <String[]>] [-PriorityClass <ProcessPriorityClass>] [-PassThru]
 [<CommonParameters>]
```
...
```yaml
Type: String
Parameter Sets: UsernameWaitForMsiExec, Username
Aliases:
...
```yaml
Type: SwitchParameter
Parameter Sets: UseShellExecuteWaitForMsiExec, UseShellExecute
Aliases:
...
```yaml
Type: SwitchParameter
Parameter Sets: CreateNoWindow, UseShellExecuteWaitForMsiExec, UseShellExecute, UsernameWaitForMsiExec, Username, CreateNoWindowWaitForMsiExec
Aliases:
...
Parameter Sets: UseShellExecuteWaitForMsiExec, UseShellExecute, UsernameWaitForMsiExec, Username, DefaultWaitForMsiExec, Default
Aliases:
...
```yaml
Type: SwitchParameter
Parameter Sets: UseShellExecuteWaitForMsiExec, UsernameWaitForMsiExec, CreateNoWindowWaitForMsiExec, DefaultWaitForMsiExec
Aliases:
