...
```powershell
Start-ADTProcess -FilePath <String> [-ArgumentList <String[]>] [-SecureArgumentList]
 [-WorkingDirectory <String>] [-UseUnelevatedToken] [-CreateNoWindow] [-NoWait] [-WaitForMsiExec]
 [-MsiExecWaitTime <TimeSpan>] [-WaitForChildProcesses] [-KillChildProcessesWithParent]
 [-SuccessExitCodes <Int32[]>] [-RebootExitCodes <Int32[]>] [-IgnoreExitCodes <String[]>]
 [-PriorityClass <ProcessPriorityClass>] [-StreamEncoding <Encoding>] [-ExitOnProcessFailure] [-PassThru]
 [<CommonParameters>]
...
```powershell
Start-ADTProcess -FilePath <String> [-ArgumentList <String[]>] [-SecureArgumentList]
 [-WorkingDirectory <String>] [-UseUnelevatedToken] -WindowStyle <ProcessWindowStyle> [-NoWait]
...
```powershell
Start-ADTProcess -FilePath <String> [-ArgumentList <String[]>] [-SecureArgumentList]
 [-WorkingDirectory <String>] [-UseUnelevatedToken] [-NoWait] [-WaitForMsiExec] [-MsiExecWaitTime <TimeSpan>]
 [-WaitForChildProcesses] [-KillChildProcessesWithParent] [-SuccessExitCodes <Int32[]>]
 [-RebootExitCodes <Int32[]>] [-IgnoreExitCodes <String[]>] [-PriorityClass <ProcessPriorityClass>]
 [-StreamEncoding <Encoding>] [-ExitOnProcessFailure] [-PassThru] [<CommonParameters>]
```
