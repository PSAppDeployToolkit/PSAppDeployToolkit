...
Start-ADTProcess -FilePath <String> [-ArgumentList <String[]>] [-SecureArgumentList]
 [-WorkingDirectory <String>] [-WaitForMsiExec] [-MsiExecWaitTime <TimeSpan>] [-WaitForChildProcesses]
...
Start-ADTProcess -FilePath <String> [-ArgumentList <String[]>] [-SecureArgumentList]
 ...
 [-WaitForMsiExec] [-MsiExecWaitTime <TimeSpan>] [-WaitForChildProcesses] -Timeout <TimeSpan>
...
Start-ADTProcess -FilePath <String> [-ArgumentList <String[]>] [-SecureArgumentList]
 ...
 [-WaitForMsiExec] [-MsiExecWaitTime <TimeSpan>] [-WaitForChildProcesses] [-SuccessExitCodes <Int32[]>]
 [-RebootExitCodes <Int32[]>] [-IgnoreExitCodes <String[]>] [-PriorityClass <ProcessPriorityClass>]
 [-StreamEncoding <Encoding>] [-ExitOnProcessFailure] [-PassThru] [<CommonParameters>]
```
