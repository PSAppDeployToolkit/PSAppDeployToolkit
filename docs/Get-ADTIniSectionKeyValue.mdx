---
id: Get-ADTIniSectionKeyValue
title: Get-ADTIniSectionKeyValue
hide_title: false
...
```powershell
Get-ADTIniSectionKeyValue [-FilePath] <String> [-Section] <String> [-Key] <String> [<CommonParameters>]
```
...
[https://psappdeploytoolkit.com/docs/reference/functions/Get-ADTIniSectionKeyValue](https://psappdeploytoolkit.com/docs/reference/functions/Get-ADTIniSectionKeyValue)
