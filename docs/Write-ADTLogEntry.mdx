...
```powershell
Write-ADTLogEntry [-Message] <String[]> [[-Severity] <LogSeverities>] [[-Source] <String>]
 [[-ScriptSection] <String>] [[-LogType] <String>] [[-LogFileDirectory] <String>] [[-LogFileName] <String>]
 [-PassThru] [-DebugMessage] [<CommonParameters>]
```
