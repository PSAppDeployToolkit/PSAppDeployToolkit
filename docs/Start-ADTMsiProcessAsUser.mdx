...
```yaml
Type: String
Parameter Sets: Username_FilePath, FilePath
Aliases:
...
```yaml
Type: Guid
Parameter Sets: Username_ProductCode, ProductCode
Aliases:
...
Parameter Sets: Username_InstalledApplication, InstalledApplication
Aliases:
