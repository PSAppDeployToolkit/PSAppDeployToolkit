...
Show-ADTInstallationPrompt -Message <String> [-MessageAlignment <DialogMessageAlignment>]
 ...
 [-NoWait] [-PersistPrompt] [-MinimizeWindows] [-NoExitOnTimeout] [-NotTopMost] -Title <String>
...
Show-ADTInstallationPrompt [-RequestInput] [-DefaultValue <String>] -Message <String>
 ...
 [-ButtonMiddleText <String>] [-Icon <DialogSystemIcon>] [-PersistPrompt] [-MinimizeWindows] [-NoExitOnTimeout]
