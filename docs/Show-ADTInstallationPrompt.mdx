...
Show-ADTInstallationPrompt -Message <String> [-MessageAlignment <DialogMessageAlignment>]
 ...
 [-NotTopMost] -Title <String> -Subtitle <String> [-Timeout <TimeSpan>] [<CommonParameters>]
```
...
Show-ADTInstallationPrompt [-RequestInput] [-DefaultValue <String>] -Message <String>
 ...
 [-MinimizeWindows] [-NoExitOnTimeout] [-NotTopMost] -Title <String> -Subtitle <String> [-Timeout <TimeSpan>]
 [<CommonParameters>]
```
