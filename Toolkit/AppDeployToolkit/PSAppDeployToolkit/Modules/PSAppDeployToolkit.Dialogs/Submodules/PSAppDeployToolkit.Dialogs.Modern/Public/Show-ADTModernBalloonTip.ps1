function Show-ADTModernBalloonTip
{
    <#
    ...
    .EXAMPLE
    Show-ADTModernBalloonTip -BalloonTipText 'Installation Started' -BalloonTipTitle 'Application Name'

    .EXAMPLE
    Show-ADTModernBalloonTip -BalloonTipIcon 'Info' -BalloonTipText 'Installation Started' -BalloonTipTitle 'Application Name' -BalloonTipTime 1000
    ...
    process {
        ...
        {
            Write-ADTLogEntry -Message "Bypassing Show-ADTModernBalloonTip [Mode:$($adtSession.GetPropertyValue('deployMode')), Config Show Balloon Notifications:$($adtConfig.UI.BalloonNotifications)]. BalloonTipText:$BalloonTipText"
            return
        }
        if (Test-ADTPowerPoint)
        {
            Write-ADTLogEntry -Message "Bypassing Show-ADTModernBalloonTip [Mode:$($adtSession.GetPropertyValue('deployMode')), Presentation Detected:$true]. BalloonTipText:$BalloonTipText"
            return
        }
