function Remove-ADTEdgeExtension
{
    ...
    [System.Void](Set-RegistryKey -Key 'HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Edge' -Name ExtensionSettings -Value ($installedExtensions | ConvertTo-Json -Compress))
}
