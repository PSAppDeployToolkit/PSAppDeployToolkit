    ...
    public class DvdPlayer : MediaSeekingPlayer
    {
        ...
        private void BuildGraph()
        {
            try
            {
                ...
                if (m_dvdControl == null)
                    throw new DirectXException("Could not QueryInterface the IDvdControl2 interface");
                ...
                if (dvdSubPicturePinOut == null)
                    throw new DirectXException("Could not find the sub picture pin out");
                ...
                IPin line21Out = FindPinInGraphByMediaType(MediaType.AuxLine21Data,
                                                           ...
                                                           m_graph);
                if (line21Out == null)
                    throw new DirectXException("Could not find the Line21 pin out");
                ...
                if (m_dummyRenderWindow == null)
                    throw new DirectXException("Could not QueryInterface for IVideoWindow");
