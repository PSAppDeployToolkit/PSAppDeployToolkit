...
namespace PSADT
{
    ...
    public static class Explorer
    {
        ...
        public static void RefreshDesktopAndEnvironmentVariables()
        {
            ...
            SendMessageTimeout(HWND_BROADCAST, WM_SETTINGCHANGE, IntPtr.Zero, String.Empty, SMTO_ABORTIFHUNG, 100, IntPtr.Zero);
    ...
    public static class UiAutomation
    {
        ...
        public static bool EnumWindowsProc(IntPtr hWnd, ref IntPtr lItems)
        {
            if (hWnd != IntPtr.Zero)
            {
                ...
                List<IntPtr> items = hItems.Target as List<IntPtr> ?? new List<IntPtr>();
                items.Add(hWnd);
                return true;
            }
            else
