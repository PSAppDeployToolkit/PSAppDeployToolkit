...
try
{
                                ...
                                [System.Collections.Generic.KeyValuePair[System.String, System.Management.Automation.ScriptBlock]]::new([System.String]::Empty, {
                                        @{
                                            Assets = @{
                                                ...
                                                # Specify optional filename or Base64 string of the tray icon. Requires PSAppDeployToolkit 4.2.0 or higher.
                                                TaskbarIcon = $null
                                            }
                                            ...
                                            Toolkit = @{
                                                ...
                                                # Specify the path for the cache folder when the caller is not an admin. Prevents non-admins caching contents accessible by all users. Requires PSAppDeployToolkit 4.2.0 or higher.
                                                ...
                                                # Specify the maximum amount of hierarchical structures to maintain when LogToHierarchy is true. Requires PSAppDeployToolkit 4.2.0 or higher.
                                                LogMaxHierarchy = 3
                                            ...
                                            UI = @{
                                                ...
                                                # The value specified here should be literally typed (i.e. `FluentAccentColorDark = 0xFF0078D7`) and not wrapped in quotes. Requires PSAppDeployToolkit 4.2.0 or higher.
                                                ...
                                                # Time in seconds to display the restart prompt before a restart is triggered. Default is 60 seconds. Requires PSAppDeployToolkit 4.2.0 or higher.
                                                RestartPromptInteractiveCountdown = 60

                                                # Time in seconds at the end of the restart prompt's countdown where the window can no longer be hidden. Default is 30 seconds. Requires PSAppDeployToolkit 4.2.0 or higher.
                                                ...
                                                # Time in seconds to countdown before triggering a silent restart. Default is 5 seconds. Requires PSAppDeployToolkit 4.2.0 or higher.
                                                RestartPromptSilentCountdown = 5
                                            }
                                        }
                                    })
    ...
    $Module.ModuleInfo.OnRemove = {
        ...
        Get-EventSubscriber -SourceIdentifier PowerShell.Exiting -Force -ErrorAction Ignore | & { process { if ($_.Action.Command.Contains('Close-ADTClientServerInstance')) { return $_ } } } | Unregister-Event -Force
