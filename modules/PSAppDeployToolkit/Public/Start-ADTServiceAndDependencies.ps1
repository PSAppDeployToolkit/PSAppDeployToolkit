...
function Start-ADTServiceAndDependencies
{
    ...
    .PARAMETER Name
        Specifies the service name(s) of services to be started. Wildcards are permitted.

    .PARAMETER DisplayName
        Specifies the display name(s) of services to be started. Wildcards are permitted.
    ...
    .LINK
        https://github.com/PSAppDeployToolkit/PSAppDeployToolkit/blob/main/modules/PSAppDeployToolkit/Public/Start-ADTServiceAndDependencies.ps1
    #>
