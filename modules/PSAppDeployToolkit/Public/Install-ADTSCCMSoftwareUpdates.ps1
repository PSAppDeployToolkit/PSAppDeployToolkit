...
function Install-ADTSCCMSoftwareUpdates
{
    ...
    .LINK
        https://github.com/PSAppDeployToolkit/PSAppDeployToolkit/blob/main/modules/PSAppDeployToolkit/Public/Install-ADTSCCMSoftwareUpdates.ps1
    #>
    ...
    process
    {
        ...
        try
        {
            try
            {
                ...
                {
                    $naerParams = @{
                        Exception = [System.Runtime.InteropServices.ExternalException]::new("The InstallUpdates method invocation returned an error code of [$($result.ReturnValue)].", $result.ReturnValue)
                        Category = [System.Management.Automation.ErrorCategory]::InvalidResult
