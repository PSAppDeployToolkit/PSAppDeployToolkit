...
function Invoke-ADTCommandWithRetries
{
    ...
    .EXAMPLE
        ...
        Gets the hash of a file on an SMB share. If the connection to the SMB share drops, it will retry the command every second until it successfully gets the hash or 90 seconds have passed since the initial attempt.
