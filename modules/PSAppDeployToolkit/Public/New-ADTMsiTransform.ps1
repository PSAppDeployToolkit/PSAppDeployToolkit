...
function New-ADTMsiTransform
{
    ...
    .DESCRIPTION
        The `New-ADTMsiTransform` function creates a transform file for an MSI database that adds/modifies entries in the "Property" Windows Installer database table. This function allows you to specify an existing transform to apply before making changes and to define the path for the new transform file. If the new transform file already exists, it will be deleted before creating a new one.
    ...
    .LINK
        https://github.com/PSAppDeployToolkit/PSAppDeployToolkit/blob/main/modules/PSAppDeployToolkit/Public/New-ADTMsiTransform.ps1
    #>
