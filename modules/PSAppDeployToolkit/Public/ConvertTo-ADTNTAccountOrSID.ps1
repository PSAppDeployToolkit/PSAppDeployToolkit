...
function ConvertTo-ADTNTAccountOrSID
{
    ...
    .LINK
        https://github.com/PSAppDeployToolkit/PSAppDeployToolkit/blob/main/modules/PSAppDeployToolkit/Public/ConvertTo-ADTNTAccountOrSID.ps1
    ...
    begin
    {
        ...
        function Convert-ADTSIDToNTAccount
        {
            ...
            catch
            {
                ...
                $TargetNtAccount = try
                {
                    [PSADT.AccountManagement.GroupPolicyAccountInfo]::Get() | & { process { if ($_.SID.Equals($TargetSid)) { return $_.Username } } } | Select-Object -First 1
                }
                catch
                {
                    $null = $null
        ...
        function Convert-ADTNTAccountToSID
        {
            ...
            catch
            {
                ...
                $TargetSid = try
                {
                    [PSADT.AccountManagement.GroupPolicyAccountInfo]::Get() | & { process { if ($_.Username.Equals($TargetNtAccount)) { return $_.SID } } } | Select-Object -First 1
                }
                catch
                {
                    $null = $null
