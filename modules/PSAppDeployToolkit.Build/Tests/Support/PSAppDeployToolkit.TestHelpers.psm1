...
function Get-ADTTestUninstallCommand
{
    ...
    .PARAMETER Unqualified
        Name the program without saying where it lives, for a test covering resolution against the search path. A command line written to the registry is not obliged to spell out the path, and most do not.
