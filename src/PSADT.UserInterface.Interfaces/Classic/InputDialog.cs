...
namespace PSADT.UserInterface.Interfaces.Classic
{
    ...
    /// </summary>
    internal sealed partial class InputDialog : CustomDialog, IModalDialog
    {
        /// <summary>
        ...
        /// <exception cref="NotSupportedException">Thrown if the dialog is instantiated in runtime license mode, as InputDialog is only implemented for the
