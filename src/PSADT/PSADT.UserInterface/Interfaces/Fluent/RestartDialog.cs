...
namespace PSADT.UserInterface.Interfaces.Fluent
{
    ...
    internal sealed class RestartDialog : FluentDialog, IModalDialog
    {
        ...
        internal RestartDialog(RestartDialogOptions options) : base(options, "Timeout", options.CustomMessageText, options.CountdownDuration, options.CountdownNoMinimizeDuration)
        {
