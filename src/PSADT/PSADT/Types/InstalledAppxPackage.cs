...
namespace PSADT.Types
{
    ...
    public sealed record InstalledAppxPackage : InstalledApplication
    {
        ...
        /// <param name="provisionedPackage">The full name of the provisioned package, if applicable.</param>
        ...
        /// <summary>
        /// Indicates whether the package is non-removable.
        /// </summary>
        ...
        /// <summary>
        /// The full name of the package that provisioned this Appx package, if any.
        /// </summary>
