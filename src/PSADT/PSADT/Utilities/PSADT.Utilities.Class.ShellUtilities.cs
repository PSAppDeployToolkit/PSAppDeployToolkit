...
namespace PSADT.Utilities
{
    ...
    public static class ShellUtilities
    {
        ...
        public static void RefreshDesktopAndEnvironmentVariables()
        {
            ...
            User32.SendMessageTimeout(HWND.HWND_BROADCAST, PInvoke.WM_SETTINGCHANGE, new WPARAM(0), NullSafeHandles.NullSafeMemoryHandle, SEND_MESSAGE_TIMEOUT_FLAGS.SMTO_ABORTIFHUNG, 100, out _);
