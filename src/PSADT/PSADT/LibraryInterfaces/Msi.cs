...
namespace PSADT.LibraryInterfaces
{
    ...
    internal static class Msi
    {
        ...
        internal static WIN32_ERROR MsiGetSummaryInformation(SafeHandle? hDatabase, uint uiUpdateCount, out MsiCloseHandleSafeHandle phSummaryInfo) => MsiGetSummaryInformation(hDatabase, null, uiUpdateCount, out phSummaryInfo);
        ...
        internal static WIN32_ERROR MsiGetSummaryInformation(string? szDatabasePath, uint uiUpdateCount, out MsiCloseHandleSafeHandle phSummaryInfo) => MsiGetSummaryInformation(null, szDatabasePath, uiUpdateCount, out phSummaryInfo);
