    ...
    public class DeploymentSession
    {
        ...
        public DeploymentSession(IReadOnlyDictionary<string, object>? parameters = null, bool? noExitOnClose = null, SessionState? callerSessionState = null)
        {
            ...
            try
            {
                ...
                {
                    WriteLogEntry($"[{appDeployToolkitName}] was started with ServiceUI as a parent process. This is no longer required with PSAppDeployToolkit 4.1.2 and will be forbidden in a later release.", LogSeverity.Warning);
                }
