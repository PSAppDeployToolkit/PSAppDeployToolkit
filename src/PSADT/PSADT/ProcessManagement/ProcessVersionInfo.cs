...
namespace PSADT.ProcessManagement
{
    ...
    public sealed record ProcessVersionInfo
    {
        ...
        private ProcessVersionInfo(Process process, string? filePath, ReadOnlyDictionary<string, string>? ntPathLookupTable)
        {
            ...
            FileName = !string.IsNullOrWhiteSpace(filePath) ? filePath! : ProcessTools.GetProcessImageName(process.Id, ntPathLookupTable ?? FileSystemUtilities.GetNtPathLookupTable());
            Process = process;
