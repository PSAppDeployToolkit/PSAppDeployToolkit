...
namespace PSADT.DeviceManagement
{
    ...
    public static class HardwareInfo
    {
        ...
        static HardwareInfo()
        {
            ...
            PlatformFirmwareInformation = PlatformFirmwareInformation.Get(buffer) ?? throw new NotSupportedException("The query for platform firmware information returned a null result.");
            SystemInformation = SystemInformation.Get(buffer) ?? throw new NotSupportedException("The query for platform firmware information returned a null result.");
            SystemEnclosure = SystemEnclosure.Get(buffer) ?? throw new NotSupportedException("The query for platform firmware information returned a null result.");
        }
