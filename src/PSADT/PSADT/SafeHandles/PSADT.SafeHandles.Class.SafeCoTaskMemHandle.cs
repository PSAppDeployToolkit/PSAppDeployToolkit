...
namespace PSADT.SafeHandles
{
    ...
    internal sealed class SafeCoTaskMemHandle : SafeMemoryHandle
    {
        ...
        internal static SafeCoTaskMemHandle Alloc(int length)
        {
            ...
            return new SafeCoTaskMemHandle(handle, length, true);
        }
        ...
        {
            return new SafeCoTaskMemHandle(Marshal.StringToCoTaskMemUni(input), (input.Length + 1) * 2, true);
        }
        ...
        internal override void ReAlloc(int length)
        {
            ...
            var newHandle = Marshal.ReAllocCoTaskMem(handle, length);
