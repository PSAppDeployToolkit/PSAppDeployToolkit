...
{
    /// <summary>
    /// Provides extension methods for working with memory addresses represented by <see cref="nuint"/>. These methods
    ...
    internal static class UIntPtrExtensions
    {
        ...
        /// <param name="handle">A pointer represented as an nuint to the start of the memory region.</param>
