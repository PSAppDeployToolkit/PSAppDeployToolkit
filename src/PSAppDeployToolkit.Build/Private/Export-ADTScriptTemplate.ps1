...
function Export-ADTScriptTemplate
{
    ...
    if ((Test-ADTBuildingWithinPipeline) -and !(Get-Variable -Name MyInvocation -Scope 1 -ValueOnly).MyCommand.Name.Equals('Invoke-ADTCustomModuleBuild'))
    {
        return
    }
