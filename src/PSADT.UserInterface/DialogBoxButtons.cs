...
namespace PSADT.UserInterface
{
    ...
    /// </summary>
    /// <remarks>The members are the <c language="text">MB_*</c> button constants, which Win32 packs into the low nibble of a
    ...
    /// <c language="csharp">MESSAGEBOX_STYLE</c> and combining those, so nothing needs to combine two members of this type - and
    /// marking it as flags would suggest otherwise while quietly turning <c language="csharp">OkCancel | AbortRetryIgnore</c> into
    /// <c language="csharp">YesNoCancel</c>.</remarks>
