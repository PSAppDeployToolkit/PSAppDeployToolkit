...
function Test-ADTServiceExists
{
    ...
    process
    {
        ...
        {
            Invoke-ADTFunctionErrorHandler -Cmdlet $PSCmdlet -SessionState $ExecutionContext.get_SessionState() -ErrorRecord $_ -LogMessage "Failed check to see if service [$Name] exists."
        }
    }
