#-----------------------------------------------------------------------------
#
# MARK: Set-ADTIniSectionKeyValue
#
#-----------------------------------------------------------------------------

function Set-ADTIniSectionKeyValue
{
    <#
    .SYNOPSIS
    ...
    .EXAMPLE
        Set-ADTIniSectionKeyValue -FilePath "$env:ProgramFilesX86\IBM\Notes\notes.ini" -Section 'Notes' -Key 'KeyFileName' -Value 'MyFile.ID'
    ...
    .LINK
        https://psappdeploytoolkit.com/docs/reference/functions/Set-ADTIniSectionKeyValue
    #>
