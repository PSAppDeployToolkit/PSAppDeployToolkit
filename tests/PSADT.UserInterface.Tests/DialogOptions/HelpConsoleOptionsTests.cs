...
namespace PSADT.UserInterface.Tests.DialogOptions
{
    ...
    /// the map is copied into nested <c language="csharp">EquatableDictionary</c> instances and rebuilt as a read-only view on
    /// each read.
    /// </remarks>
    public sealed class HelpConsoleOptionsTests
    {
        ...
        /// </summary>
        /// <remarks>
        /// The reason the backing field is a nested <c language="csharp">EquatableDictionary</c>: the outer dictionary compares
